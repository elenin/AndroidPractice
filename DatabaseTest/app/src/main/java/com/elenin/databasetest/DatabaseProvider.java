package com.elenin.databasetest;
...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.elenin.databasetest.provider";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        public String getType(Uri uri) {
            switch (uriMatcher.match(uri)) {
                case BOOK_DIR:
                    return "vnd.android.cursor.dir/vnd.com.elenin.databasetest. provider.book";
                case BOOK_ITEM:
                    return "vnd.android.cursor.item/vnd.com.elenin.databasetest. provider.book";
                case CATEGORY_DIR:
                    return "vnd.android.cursor.dir/vnd.com.elenin.databasetest. provider.category";
                case CATEGORY_ITEM:
                    return "vnd.android.cursor.item/vnd.com.elenin.databasetest. provider.category";
            }
            return null;
        }
}
